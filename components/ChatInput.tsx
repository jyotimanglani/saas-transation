...
import { User } from "@/lib/converters/User";
import { addDoc, doc, getDocs, serverTimestamp } from "firebase/firestore";
import { limitedMessagesRef, messagesRef } from "@/lib/converters/Messages";
...
function ChatInput({ chatId }: { chatId: string }) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    //TODO: check if user is pro and limit them creating a chat
